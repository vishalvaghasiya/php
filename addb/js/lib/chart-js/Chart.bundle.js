...
module.exports = function(Chart) {
	 ...
	 * since responsiveness is handled by the common.resize() method. The config is used
	...
	Chart.Controller = function(item, config, instance) {
		...
		if (!context || !canvas) {
			...
			// the chart initialization but after setting basic chart / common properties that
	...
	helpers.extend(Chart.Controller.prototype, /** @lends Chart.Controller */ {
		...
		*/
		...
		draw: function(ease) {
			...
			// Draw each dataset via its respective common (reversed to support proper line stacking)
			helpers.each(me.data.datasets, function(dataset, datasetIndex) {
...
module.exports = function(Chart) {
	...
	Chart.defaults.global.legend = {
		...
		onClick: function(e, legendItem) {
			...
			// See common.isDatasetVisible comment
